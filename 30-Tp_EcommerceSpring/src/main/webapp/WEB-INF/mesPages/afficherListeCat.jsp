...
<h5><a href="${pageContext.request.contextPath }/adminPro/affichFormAjoutCat">Ajout categorie</a></h5>
...
<td><a href="supprimerCategorie?id_param=${emp.id}">supp</a>|<a href="affichFormmodifCat?id_param=${emp.id}">Edit</a></td>
</tr>
